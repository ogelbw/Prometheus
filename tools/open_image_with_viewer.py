...
if __name__ == "__main__":
    # Example usage
    Run("/home/ogelbw/Documents/Prometheus/red_panda.jpg", "gwenview")

def ToolDescription():

    class tool_paramerters(BaseModel):
        image_path: str = Field(..., description="Path to the image file.")
        viewer_app: str = Field(..., description="Name of the viewer application. Either 'gwenview' or 'xlookphoto'.")
